...
public class PhoneController {
	...
	public String write(@ModelAttribute PersonVo personVo) {
		...
		// redirect
		// return은 때려죽여도 forward 임 / redirect: 먼저 써주면 됨
	...
	public String write2(@RequestParam("name") String name, @RequestParam("hp") String hp,
		...
		/*
		 * / 파라미터 꺼내기 System.out.println(name); System.out.println(hp);
	...
	public String list(Model model) { // Model은 미리 만들어져 있는 상자라고 생각하면 됨
		...
		// DAO 통해서 personList 주소 가져오기 (전체리스트 가져오기)
		PhoneDao phoneDao = new PhoneDao();
	...
	public String delete2(@RequestParam("no") int personId) {
